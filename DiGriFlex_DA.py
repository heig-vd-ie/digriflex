...
file_to_store = open(dir_path + r"/Data/tmp_da_inside.pickle", "wb")
...
os.system(python64_path + ' -c ' +
          ...
          'sys.path.insert(0, r\'' + dir_path + '\');'
                                                'import pickle;' +
          'file_to_read = open(r\'' + dir_path + '\' + r\'/Data/tmp_da_inside.pickle\', \'rb\');' +
          ...
          'file_to_store = open(r\'' + dir_path + '\' + r\'/Data/tmp_da.pickle\', \'wb\');' +
