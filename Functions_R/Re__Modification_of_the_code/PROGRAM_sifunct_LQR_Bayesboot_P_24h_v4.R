...
source(paste0(str1,"Function_LQR_Bayesboot_P_24h_v4.R"), echo = F)
...
save("Results_P","base_P","base_Q","Results_abs_P","P_for","Q_for", file = paste0(str1,"Results_pask_P_v4.RData"))
write.csv("Results_abs_P", paste0(str1,"Results_pask_P_v4.csv")) 
