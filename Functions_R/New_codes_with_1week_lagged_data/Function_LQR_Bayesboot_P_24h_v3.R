...
Data_path <- paste("C:/Users/",user_name_str,"/Desktop/DiGriFlex_Code/Functions_R/New_codes_with_1week_lagged_data/", sep="")
...
LQR_Bayesboot <- function(pred_for, h, N_boot) {
  ...
  load(paste0(Data_path,"DATA_tra_v3.RData"))
  ...
  DATA_tra <- data.frame("P"=P_tra, "Plag"=pred_tra[,1],     "Qlag"=pred_tra[,2],
                                    "Plag1008"=pred_tra[,3], "Qlag1008"=pred_tra[,4],
                                    "avgP"=pred_tra[,5],     "avgQ"=pred_tra[,6])
  DATA_for <- data.frame("P"=NaN,   "Plag"=pred_for[,1],     "Qlag"=pred_for[,2],
                                    "Plag1008"=pred_for[,3], "Qlag1008"=pred_for[,4],
                                    "avgP"=pred_for[,5],     "avgQ"=pred_for[,6])
  ...
  for (q in c(1,5,9))
  {
    ...
    { mdl_fit <- rq( P ~ Plag + Qlag + Plag1008 + Qlag1008 +
                         Plag*Qlag + Plag1008*Qlag1008,
                     tau = Q01[q], data = d)
