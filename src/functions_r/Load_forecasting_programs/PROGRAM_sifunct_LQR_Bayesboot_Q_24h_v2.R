...
source(paste0(str1,"Function_LQR_Bayesboot_Q_24h_v2.R"), echo = F)
...
save("Results_Q","base_P","base_Q","Results_abs_Q","Q_for", file = paste0(str1,"Results_pask_Q_v2.RData"))
write.csv("Results_abs_Q", paste0(str1,"Results_pask_Q_v2.csv")) 
